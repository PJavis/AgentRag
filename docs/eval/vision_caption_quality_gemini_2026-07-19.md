...
Zero duplicates: 1330 segments / 1330 distinct `content_hash` (delete-first idempotency held).
Captions substantial (length min 282 / median 664 / max 1068 chars); refusal/garbage scan = 0.
