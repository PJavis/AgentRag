...
source .env
for run in 1 2; do
  VISION_PROVIDER=gemini VISION_MODEL=gemini-2.5-flash VISION_MAX_RPM=10 VISION_DESCRIBE_BATCH=1 VISUAL_EMBEDDING_ENABLED=false \
...
```bash
source .env
VISION_PROVIDER=gemini VISION_MODEL=gemini-2.5-flash VISION_MAX_RPM=10 VISION_MAX_CONCURRENCY=4 \
