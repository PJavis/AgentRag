export const bnIN = {
  ...
  chat: {
    qaSimpler: "সহজভাবে ব্যাখ্যা",
    qaDetail: "আরও বিস্তারিত",
    qaKeyPoints: "মূল পয়েন্ট",
    qaExample: "উদাহরণ দিন",
    intentSummarize: "সারসংক্ষেপ",
    intentExplain: "ব্যাখ্যা",
    intentCompare: "তুলনা",
    starterSummary: "ডকুমেন্ট সারসংক্ষেপ",
    readingTime: "{min} মিনিট পড়া",
    readingTimeTitle: "আনুমানিক পড়ার সময়",
    sessions: "সেশনগুলি",
