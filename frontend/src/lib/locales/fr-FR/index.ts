export const frFR = {
  ...
  chat: {
    qaSimpler: "Expliquer simplement",
    qaDetail: "Plus de détails",
    qaKeyPoints: "Points clés",
    qaExample: "Donner un exemple",
    intentSummarize: "Résumer",
    intentExplain: "Expliquer",
    intentCompare: "Comparer",
    starterSummary: "Résumer le document",
    readingTime: "{min} min de lecture",
    readingTimeTitle: "Temps de lecture estimé",
    sessions: "Sessions",
