export const itIT = {
  ...
  chat: {
    qaSimpler: "Spiega in modo semplice",
    qaDetail: "Più dettagli",
    qaKeyPoints: "Punti chiave",
    qaExample: "Fai un esempio",
    intentSummarize: "Riassumi",
    intentExplain: "Spiega",
    intentCompare: "Confronta",
    starterSummary: "Riassumi documento",
    readingTime: "{min} min di lettura",
    readingTimeTitle: "Tempo di lettura stimato",
    sessions: "Sessioni",
  ...
  ragSignals: {
    ...
    domainTitle: "Domain the query was routed to",
  },
  searchPage: {
    askAndSearch: "Chiedi e cerca",
