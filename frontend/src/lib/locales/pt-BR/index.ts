export const ptBR = {
  ...
  chat: {
    qaSimpler: "Explicar de forma simples",
    qaDetail: "Mais detalhes",
    qaKeyPoints: "Pontos principais",
    qaExample: "Dar um exemplo",
    intentSummarize: "Resumir",
    intentExplain: "Explicar",
    intentCompare: "Comparar",
    starterSummary: "Resumir documento",
    readingTime: "{min} min de leitura",
    readingTimeTitle: "Tempo estimado de leitura",
    sessions: "Sessões",
