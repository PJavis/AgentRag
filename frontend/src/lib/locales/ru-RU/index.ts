export const ruRU = {
  ...
  chat: {
    qaSimpler: "Объяснить проще",
    qaDetail: "Подробнее",
    qaKeyPoints: "Ключевые моменты",
    qaExample: "Привести пример",
    intentSummarize: "Кратко",
    intentExplain: "Объяснить",
    intentCompare: "Сравнить",
    starterSummary: "Кратко о документе",
    readingTime: "{min} мин чтения",
    readingTimeTitle: "Примерное время чтения",
    sessions: "Сессии",
