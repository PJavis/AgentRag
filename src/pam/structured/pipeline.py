...
from src.pam.structured.extractor import StructuredExtractor
from src.pam.structured.schema_discovery import SchemaDiscoveryModule
from src.pam.structured.sql_engine import SQLReasoningEngine
from src.pam.structured.synthesizer import AnswerSynthesizer
...
class StructuredReasoningPipeline:
    ...
    def _raw_sql_result(
        ...
        from src.pam.structured.synthesizer import AnswerSynthesizer as S
        synth = S.__new__(S)
